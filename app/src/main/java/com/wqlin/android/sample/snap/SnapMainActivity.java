package com.wqlin.android.sample.snap;
...
public class SnapMainActivity extends AppCompatActivity implements Toolbar.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.inflateMenu(R.menu.snap_main);
