package com.wqlin.android.sample;
...
public class HomeActivity extends ListActivity {
    ...
    public static final String APP_CAGEGORY = "com.wqlin.android.sample.cagegory";
    public static final String APP_PATH = "com.wqlin.android.sample.Path";
